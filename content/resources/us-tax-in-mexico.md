---
title: "U.S. Tax in Mexico: Expat Filing, Treaty Planning, and Mexican Investment in the U.S."
description: "U.S. tax guide for Americans living in Mexico and Mexican residents investing in the U.S., including treaty issues, Mexican entities, U.S. LLCs, and U.S. real estate."
date: 2026-04-20
weight: 10
...
strategy_snapshot:
  ...
  bullets:
    - label: Searches usually start with
      text: "American living in Mexico taxes, U.S. tax in Mexico, Mexican-owned U.S. LLC, or U.S.-Mexico treaty questions."
    - label: Best consulting use
      text: "Confirm who is resident where, what the Mexican entity actually is for U.S. tax purposes, and how income will move before the first return is filed."
    - label: Biggest trap
      text: "Assuming the treaty alone answers the filing question without checking entity classification, state residency, and foreign account reporting."
faqs:
  - q: "Do Americans living in Mexico still file a U.S. tax return?"
    a: "Yes. U.S. citizens and many green card holders generally continue filing Form 1040 each year while living in Mexico, and many also need FBAR or Form 8938 reporting for Mexican financial accounts."
  - q: "Does the U.S.-Mexico income tax treaty mean I do not owe U.S. tax?"
    a: "No. The treaty can help with sourcing, withholding, and double-tax coordination, but it does not replace the return itself or automatically eliminate U.S. filing obligations."
  - q: "Can a Mexican resident own a U.S. LLC?"
    a: "Yes. The bigger question is whether a U.S. LLC is the right structure, how it will be taxed, what U.S. forms it will trigger, and how money will move between the U.S. and Mexico."
---
...
{{< pullquote attribution="The key issue" >}}
Mexico files usually go wrong when the return is treated as the project. The structure, the residency position, and the entity classification are the real project.
{{< /pullquote >}}
...
The U.S. still taxes citizens and many green card holders on worldwide income, so living in Mexico does not switch off the Form 1040. Mexico is also on the IRS [U.S. income tax treaty list](https://www.irs.gov/businesses/international-businesses/united-states-income-tax-treaties-a-to-z), which means treaty analysis can matter, but the treaty is still only one layer of the file.
...
If the issue is foreign accounts, Mexican entities, or cross-border ownership for a U.S. person, start with [U.S. Persons with International Ties](/services/international-tax/u-s-with-international-ties/).

If you are an American already living in Mexico and need annual filing plus planning support, start with [U.S. Expats Abroad](/services/international-tax/expats/).

If you are a Mexican resident opening a U.S. entity or investing in the U.S., start with [Foreign Business and Investors](/services/international-tax/foreign-business-and-investors/).
{{< /callout >}}
