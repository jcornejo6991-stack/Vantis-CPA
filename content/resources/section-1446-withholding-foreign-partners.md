---
title: "Section 1446 Withholding: U.S. Partnerships with Foreign Partners"
description: "U.S. partnerships that allocate effectively connected income to nonresident partners must withhold under Section 1446 and file Forms 8804 and 8805, regardless of whether cash is distributed."
date: 2026-04-19
practices: ["inbound"]
...
strategy_snapshot:
  ...
  bullets:
    ...
    - label: Partnership Obligation
      text: "The partnership must withhold on the foreign partner's allocable share, file Form 8804 annually, and issue Form 8805 to each foreign partner."
    - label: Biggest Trap
      text: "Treating Section 1446 as the foreign partner's problem. The withholding obligation belongs to the partnership, and the exposure for noncompliance sits there too."
faqs:
  - q: "What is Section 1446 withholding?"
    a: "It is a withholding requirement that applies when a U.S. partnership allocates effectively connected taxable income to a nonresident partner. The partnership withholds on that allocation regardless of whether a distribution is made."
  - q: "What are Forms 8804 and 8805?"
    a: "Form 8804 is the partnership's annual withholding tax return under Section 1446. Form 8805 is issued to each foreign partner and shows their allocable share of income and the withholding credited to them."
  - q: "Does the foreign partner still need to file a U.S. return?"
...
| Filing | Standard Due Date | Extended Due Date |
|---|---|---|
| Form 8813 (quarterly payments) | April 15, June 15, Sept 15, Dec 15 | No extension available |
| Form 8804 (annual return) | March 15 | September 15 |
| Form 8805 (foreign partner statement) | March 15 | September 15 |
| Foreign partner Form 1040-NR | June 15 | October 15 |
...
{{< callout title="Common gap" tone="warning" >}}
Partnerships sometimes file the 8804 and 8805 without coordinating with foreign partners on the 1040-NR side. That creates a mismatch that can result in duplicate withholding or unclaimed credits.
{{< /callout >}}
