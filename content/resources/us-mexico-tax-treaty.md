---
title: "U.S.-Mexico Tax Treaty: What It Covers and How It Applies"
description: "The U.S.-Mexico tax treaty reduces double taxation on income earned across borders. This guide covers who it applies to, key provisions on dividends, interest, royalties, capital gains, and how it interacts with FBAR and FATCA."
date: 2026-06-17
practices: ["international", "individuals"]
services: ["international-tax"]
featured: false
subtopic: "International & Treaties"
primary_cluster: "international-tax"
clusters: ["international-tax", "foreign-investors"]
strategy_snapshot:
  summary: "The U.S.-Mexico Income Tax Treaty limits how much each country can tax income flowing between them, but it does not eliminate U.S. reporting obligations for Americans in Mexico or Mexicans investing in the U.S. Understanding which provisions apply depends on residency, entity type, and income category."
  bullets:
    - label: Treaty helps most when
      text: "A U.S. person earns passive income (dividends, interest, royalties) from Mexican sources, or a Mexican resident earns U.S.-source income and needs to avoid double taxation."
    - label: Treaty does not eliminate
      text: "U.S. reporting requirements. Americans in Mexico still file U.S. returns, FBAR, and FATCA forms regardless of what the treaty says about tax rates."
    - label: Most common planning use
      text: "Reducing withholding tax rates on cross-border payments and applying tie-breaker rules when a person qualifies as a tax resident of both countries."
faqs:
  - q: "Does the U.S.-Mexico tax treaty eliminate double taxation?"
    a: "It reduces double taxation but does not eliminate it entirely. The treaty limits withholding rates on certain income types and allows residents of one country to claim foreign tax credits in the other. U.S. citizens living in Mexico still owe U.S. tax on worldwide income."
  - q: "Who qualifies as a resident under the U.S.-Mexico treaty?"
    a: "A person is a treaty resident of a country if they are subject to tax there by reason of domicile, residence, citizenship, place of management, or similar connection. U.S. citizens are always U.S. residents for treaty purposes, even if they live in Mexico full time."
  - q: "What is the withholding rate on dividends under the U.S.-Mexico treaty?"
    a: "The treaty generally limits withholding on dividends to 10% when the recipient owns at least 10% of the paying company, and 15% in other cases. Mexico's domestic withholding rate on dividends can be higher without the treaty."
  - q: "Does the treaty cover Mexican Social Security contributions?"
    a: "The U.S. and Mexico have a Totalization Agreement separate from the income tax treaty. It prevents workers from paying into both countries' social security systems simultaneously and coordinates benefit eligibility."
  - q: "Can a Mexican national living in the U.S. use the treaty to reduce taxes?"
    a: "Yes. A Mexican national who is a U.S. tax resident can use the treaty to claim reduced withholding on Mexican-source income and to avoid double taxation on income taxed in both countries."
---
...
{{< callout title="The key rule for U.S. citizens" tone="comparison" >}}
U.S. citizens are always taxed on worldwide income regardless of the treaty. The treaty's residency provisions do not allow a U.S. citizen to claim non-U.S. resident status and escape U.S. taxation. It can reduce Mexican tax on U.S.-source income and reduce U.S. tax on Mexican-source income through credits, but it does not eliminate U.S. filing obligations.
{{< /callout >}}
...
| Interest | 10–15% | Rate depends on payer type; bank interest may qualify for lower rate |
| Royalties (general) | 10% | Covers patents, trademarks, software |
| Royalties (cultural) | 10% | Covers copyrights, literary works |
| Capital gains | Complex | Generally taxed in the country of residence, with exceptions for real estate and certain company interests |
...
{{< pullquote attribution="The compliance gap" >}}
