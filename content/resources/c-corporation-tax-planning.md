---
title: "C-Corporation Tax Planning: Double Taxation, Retained Earnings, and Owner Compensation"
description: "How C-corps are taxed at the entity and shareholder level, when retaining earnings at the 21% corporate rate makes sense, how to manage owner compensation versus dividends, and what exit planning looks like."
date: 2026-04-19
practices: ["business"]
...
strategy_snapshot:
  summary: "C-corp planning is largely about managing the timing and form of the double tax. The 21% corporate rate can be an advantage when earnings are retained for growth, but that advantage reverses the moment money comes out as dividends or the assets are sold."
  bullets:
    - label: Double tax on distributions
      text: "Corporate income is taxed at 21%. Dividends to shareholders are taxed again at qualified dividend rates. A dollar of profit can cost 35 to 50 cents total before it reaches the owner."
    - label: Compensation is deductible
      text: "Salary paid to an owner-employee reduces corporate taxable income. Dividends do not. This makes compensation the default tool for moving money out of a profitable C-corp."
    - label: Exit planning
      text: "An asset sale produces a corporate-level tax and then a shareholder-level tax. A stock sale avoids corporate tax. Buyers usually prefer asset deals, which creates a structural negotiation in most C-corp exits."
faqs:
...
{{< callout title="The practical approach" tone="note" >}}
C-corp owner compensation should be documented the same way as any other executive's: role defined, comparable pay reviewed, compensation set before year-end and not adjusted backward to hit a tax target.
{{< /callout >}}
