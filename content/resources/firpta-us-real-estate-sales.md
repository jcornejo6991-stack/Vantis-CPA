---
title: "FIRPTA: Foreign Sellers of U.S. Real Estate"
description: "FIRPTA requires buyers to withhold 15% of gross proceeds when a foreign seller disposes of U.S. real estate. Here is how the withholding works, when certificates can reduce it, and how the sale is reported."
date: 2026-04-19
...
strategy_snapshot:
  summary: "FIRPTA withholding is based on gross sales price, not actual gain. The biggest planning opportunity is identifying early whether a withholding certificate can reduce the amount tied up at closing."
  bullets:
    - label: Trigger Point
      text: "A foreign person sells U.S. real estate and the buyer becomes responsible for withholding under FIRPTA."
    - label: Best Use Case
      text: "The seller expects the actual tax to be far lower than 15% of gross proceeds because basis, selling costs, or loss position reduce the gain."
    - label: Biggest Trap
      text: "Waiting until closing to address FIRPTA, when there is no time to apply for a withholding certificate or coordinate with escrow."
faqs:
  - q: "Is FIRPTA withholding the same thing as the tax owed?"
    a: "No. FIRPTA withholding is a deposit against the seller's eventual U.S. tax liability. The actual tax is determined later on the seller's U.S. return."
  - q: "What is the standard FIRPTA withholding rate?"
    a: "In many cases the buyer must withhold 15% of the gross sales price. That amount is based on proceeds, not on the seller's net gain."
  - q: "Can FIRPTA withholding be reduced?"
    a: "Yes. A withholding certificate may reduce or eliminate withholding when the expected tax is lower than the standard withholding amount, but timing is critical."
---
...
The real FIRPTA problem is not usually the tax. It is the cash tied up at closing when withholding is based on gross proceeds instead of actual gain.
{{< /pullquote >}}
...
{{< callout title="Common misconception" tone="warning" >}}
Foreign sellers often assume FIRPTA means they are being taxed at 15%. In reality, 15% is usually just the withholding deposit. The actual tax may be much lower.
{{< /callout >}}
