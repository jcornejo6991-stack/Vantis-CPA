---
title: "U.S. Tax for Chileans: Treaty Planning, U.S. LLCs, and Cross-Border Filing"
description: "U.S. tax guide for Chilean investors and Americans in Chile, covering the U.S.-Chile treaty, cross-border businesses, foreign accounts, and U.S. real estate."
date: 2026-04-20
weight: 50
...
strategy_snapshot:
  ...
  bullets:
    - label: Searches usually start with
      text: "U.S. tax for Chileans, Chilean-owned U.S. LLC, American living in Chile taxes, or U.S.-Chile treaty questions."
    - label: Best consulting use
      text: "Use the treaty as one tool inside the file, not as the whole answer. Structure, residency, and reporting still drive the result."
    - label: Biggest trap
      text: "Assuming a treaty country automatically means simple compliance."
faqs:
  - q: "Does Chile have a U.S. income tax treaty?"
    a: "Yes. Chile is currently listed on the IRS U.S. income tax treaty A-to-Z page, which means treaty positions can matter more in Chile cases than in many other Latin America files."
  - q: "Do Americans living in Chile still file U.S. taxes?"
    a: "Yes. U.S. citizens and many green card holders generally continue filing Form 1040 each year while living in Chile, and many also need FBAR or Form 8938 reporting for Chilean financial accounts."
  - q: "Can a Chilean resident own a U.S. LLC or U.S. real estate?"
    a: "Yes. The planning issue is how the ownership is structured, what U.S. filings it triggers, whether treaty positions are relevant, and how profits or sale proceeds move across the border."
---
...
{{< pullquote attribution="The right mindset" >}}
Treaty language can improve the answer, but only after the ownership structure and the filing path are actually understood.
{{< /pullquote >}}
...
The IRS includes Chile on its official [U.S. income tax treaty list](https://www.irs.gov/businesses/international-businesses/united-states-income-tax-treaties-a-to-z), and SSA includes Chile on its [international agreements list](https://www.ssa.gov/international/agreement_descriptions.html). That combination makes Chile different from many Latin America files, but it still does not remove the need for entity classification and foreign reporting.
...
If you are a Chilean owner or investor entering the U.S., start with [Foreign Business and Investors](/services/international-tax/foreign-business-and-investors/).
{{< /callout >}}
