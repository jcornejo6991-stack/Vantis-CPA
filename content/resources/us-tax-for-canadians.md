---
title: "U.S. Tax for Canadians: Cross-Border Planning for Expats, Investors, and Business Owners"
description: "Practical U.S. tax guide for Canadians and Americans in Canada covering RRSPs, TFSAs, expat filing, Canadian corporations, U.S. LLCs, treaty issues, and U.S. real estate."
date: 2026-04-20
weight: 10
...
strategy_snapshot:
  ...
  bullets:
    - label: Searches usually start with
      text: "U.S. tax for Canadians, Americans living in Canada, RRSP or TFSA reporting, or Canadian-owned U.S. LLC questions."
    - label: Best consulting use
      text: "Map the person, the entity, and the country at the same time instead of treating the return, the bank accounts, and the ownership structure as separate projects."
    - label: Biggest trap
      text: "Assuming the treaty or a prior Canadian filing automatically fixes the U.S. reporting side."
faqs:
  - q: "Do Americans living in Canada still file a U.S. tax return?"
    a: "Yes. U.S. citizens and many green card holders generally continue filing Form 1040 each year even while living in Canada, and many also have FBAR or Form 8938 reporting if they hold Canadian financial accounts."
  - q: "Does the U.S.-Canada tax treaty eliminate double taxation?"
    a: "The treaty can help, but it does not replace the actual return preparation and reporting analysis. The result still depends on residency, the type of income, the entities involved, and how credits or treaty positions are claimed."
  - q: "Can a Canadian resident own U.S. real estate or a U.S. LLC?"
    a: "Yes, but the tax treatment depends on whether the asset is held directly or through an entity, whether the activity is passive or operating, and how rental income, sale proceeds, withholding, and estate exposure are handled."
---
...
Canada is one of the few countries where treaty coordination and pension coordination can matter, but that does not make the work simple. The IRS keeps the official [U.S. income tax treaty list](https://www.irs.gov/businesses/international-businesses/united-states-income-tax-treaties-a-to-z), and SSA separately maintains the [Canada totalization agreement overview](https://www.ssa.gov/international/Agreement_Pamphlets/canada.html). In practice, those official frameworks are only the starting point.
...
If you are entering the U.S. as a Canadian owner or investor, use [Foreign Business and Investors](/services/international-tax/foreign-business-and-investors/).
{{< /callout >}}
