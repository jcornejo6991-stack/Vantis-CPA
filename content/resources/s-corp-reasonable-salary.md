---
title: "S-Corp Reasonable Salary: How to Set It Without Triggering Problems"
...
strategy_snapshot:
  ...
  bullets:
    - label: Strong process
      text: "Set salary using role, hours, industry comparables, and business economics before distributions start flowing."
    - label: Weak process
      text: "Choosing a low number because someone online said 40/60 or 50/50 is the safe split."
    - label: Biggest trap
      text: "Treating almost all profit as distributions when the business primarily depends on the owner's labor."
faqs:
  - q: "Is there an IRS-approved percentage for S-Corp salary?"
    a: "No. The IRS does not provide a single approved percentage. Reasonable compensation depends on the facts, including duties, time, training, comparables, and how the business generates revenue."
  - q: "Can an S-Corp owner take only distributions and no salary?"
    a: "Usually no if the owner performs more than minor services. The IRS treats officers who perform services and receive or are entitled to payments as employees whose compensation must be handled as wages."
  - q: "What happens if salary is too low?"
    a: "The IRS can reclassify distributions or other payments as wages subject to employment taxes, with additional tax, penalties, and interest."
---
...
{{< callout title="The key framing" tone="comparison" >}}
The issue is not whether you are allowed to take distributions. The issue is whether enough of what you received should have been treated as wages first.
{{< /callout >}}
...
{{< pullquote attribution="What usually makes a salary defensible" >}}
...
|----------|--------------|-------------------|
| Pick a percentage from social media | No IRS-approved ratio | Use role, hours, and comparables |
| Pay zero salary and take draws | High reclassification risk | Run payroll once owner services become meaningful |
| Back into salary after distributions | Looks tax-motivated | Document compensation logic up front |
| Use one number forever | Ignores business growth and role changes | Revisit salary as the business evolves |
