---
title: "U.S. Tax for Brazilians: U.S. LLCs, U.S. Real Estate, and Cross-Border Planning"
description: "Guide to U.S. tax for Brazilians and Americans in Brazil, including Brazilian entities, foreign-owned U.S. LLCs, FBAR and FATCA, and U.S. real estate."
date: 2026-04-20
weight: 20
...
strategy_snapshot:
  ...
  bullets:
    - label: Searches usually start with
      text: "Brazilian-owned U.S. LLC, U.S. tax for Brazilians, Americans living in Brazil, or Brazilian investor in U.S. real estate."
    - label: Best consulting use
      text: "Decide early how the U.S. activity will be owned and how Brazilian entities and accounts should be treated on the U.S. side."
    - label: Biggest trap
      text: "Assuming the U.S. filing can be handled later after the entity and banking setup are already in motion."
faqs:
  - q: "Does Brazil have a U.S. income tax treaty?"
    a: "Brazil is not currently listed on the IRS U.S. income tax treaty A-to-Z page, so many Brazil cases rely more heavily on structure, sourcing, withholding analysis, and foreign tax credit coordination than on treaty positions."
  - q: "Do Americans living in Brazil still file U.S. taxes?"
    a: "Yes. U.S. citizens and many green card holders generally continue filing Form 1040 each year while living in Brazil, and many also need FBAR or Form 8938 reporting for Brazilian financial accounts."
  - q: "Can a Brazilian resident own a U.S. LLC or U.S. real estate?"
    a: "Yes. The planning issue is not whether ownership is allowed. It is how the U.S. asset is held, what returns it triggers, how withholding works, and how profits or sale proceeds move back to Brazil."
---
...
{{< pullquote attribution="The pattern to watch" >}}
...
For U.S. tax purposes, the first question is usually how the Brazilian entity or investment should be classified and reported. The IRS maintains the official [U.S. income tax treaty list](https://www.irs.gov/businesses/international-businesses/united-states-income-tax-treaties-a-to-z), and Brazil is not currently listed there. At the same time, SSA does include Brazil on its [international agreements list](https://www.ssa.gov/international/agreement_descriptions.html), which means social-security coordination can be a separate issue from income-tax treaty planning.
...
If you are entering the U.S. as a Brazilian owner or investor, start with [Foreign Business and Investors](/services/international-tax/foreign-business-and-investors/).
{{< /callout >}}
