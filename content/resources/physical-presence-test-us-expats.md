---
title: "Physical Presence Test for U.S. Expats: How to Track the 330 Days"
description: "The physical presence test for the Foreign Earned Income Exclusion is stricter than most expats expect. It requires 330 full days in foreign countries during a 12-month period, and travel days are often where the calculation breaks."
date: 2026-04-22
practices: ["expats"]
...
strategy_snapshot:
  ...
  bullets:
    - label: The core rule
      text: "You must be physically present in foreign countries for at least 330 full days during any 12-month period that includes part of the tax year."
    - label: Best planning move
      text: "Choose the strongest 12-month window first, then map flights, U.S. visits, and partial travel days before filing Form 2555."
    - label: Biggest trap
      text: "Counting departure and arrival days as full foreign days when they usually are not."
faqs:
  - q: "Does the 330-day test use the calendar year?"
    a: "Not necessarily. It can use any 12-month period that includes part of the year at issue, which is why choosing the right window matters."
  - q: "Do travel days count?"
    a: "Only full days in a foreign country count. The day you leave the United States and the day you arrive back often do not work the way people assume."
  - q: "If I pass the physical presence test, do I automatically get the FEIE?"
    a: "No. The FEIE also has tax-home requirements, and the exclusion does not solve every issue, especially self-employment tax."
---
...
{{< callout title="Planning angle" tone="comparison" >}}
The strongest filing position usually comes from selecting the best 12-month window first and then testing your travel records against that window, not the other way around.
{{< /callout >}}
...
{{< pullquote attribution="What the test is really measuring" >}}
The physical presence test is not asking whether you felt like an expat. It is asking whether your travel record can support 330 full foreign days in a qualifying 12-month period.
{{< /pullquote >}}
...
- Whether the `FEIE` or the `Foreign Tax Credit` is the better long-term choice
- Whether a mid-year move changes the filing strategy
