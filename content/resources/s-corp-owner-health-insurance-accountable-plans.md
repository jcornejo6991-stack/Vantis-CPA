---
title: "S-Corp Owner Health Insurance, Accountable Plans, and Payroll Cleanup"
description: "S-corp owners often miss tax savings because health insurance, reimbursements, and payroll were handled casually. The fix is usually not a new entity. It is getting the owner-compensation mechanics right."
date: 2026-04-22
practices: ["business"]
...
strategy_snapshot:
  ...
  bullets:
    - label: Health insurance rule
      text: "Premiums for a more-than-2% shareholder usually need to be handled through the corporation and reported correctly on the owner's W-2 to preserve the individual deduction."
    - label: Accountable plan rule
      text: "Owner business expenses should usually be reimbursed by the corporation under a documented accountable plan instead of absorbed casually on the personal side."
    - label: Biggest trap
      text: "Treating payroll as an afterthought after a year of draws, personal card spending, and untracked reimbursements."
faqs:
  - q: "Can my S-corp pay my health insurance?"
    a: "Usually yes, but more-than-2% shareholder health insurance has to be handled correctly. The corporation's payment or reimbursement and the W-2 reporting both matter."
  - q: "Why does an accountable plan matter?"
    a: "Because it lets the corporation reimburse legitimate business expenses without treating them as wages, provided the expenses are documented and handled under accountable-plan rules."
  - q: "What does payroll cleanup usually mean?"
    a: "It usually means reconciling owner draws, reimbursements, fringe benefits, and health insurance so the books, payroll filings, and 1120-S all tell the same story."
---
...
{{< pullquote attribution="Where the savings really leak" >}}
Most S-corp cleanup work is not about exotic strategy. It is about getting wages, reimbursements, and owner-only benefits into the right buckets before the return is filed.
{{< /pullquote >}}
...
{{< callout title="What strong cleanup usually looks like" tone="comparison" >}}
The cleaner approach is to reconcile owner transactions before the year closes, run payroll with the right owner adjustments, and document reimbursements under an accountable plan instead of reconstructing everything after the fact.
{{< /callout >}}
