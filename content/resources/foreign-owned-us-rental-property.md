---
title: "Foreign-Owned U.S. Rental Property"
description: "Foreign nationals with U.S. rental property often face a harsh default tax regime unless the Section 871(d) election and nonresident filing stack are handled correctly. Here is how the rules work."
date: 2026-04-19
practices: ["inbound"]
...
aliases:
  - /services/international-tax/real-estate/foreign-owned-us-rental-property/
  - /expertise/realestate/foreign-owned-us-rental-property/
strategy_snapshot:
  summary: "For foreign owners of U.S. rental property, the main planning move is usually the Section 871(d) net-income election. Without it, withholding can apply to gross rents before expenses ever enter the calculation."
  bullets:
    - label: Default Rule
      text: "Rental income may be treated under a gross-withholding regime that ignores the property's real expenses."
    - label: Better Path
      text: "A Section 871(d) election usually allows the owner to file on net income through Form 1040-NR instead."
    - label: Biggest Trap
      text: "Owning the property for years without making the election, getting an ITIN, or aligning the reporting with how the property is actually held."
faqs:
  - q: "Do foreign owners of U.S. rental property have to file a U.S. return?"
    a: "In many cases, yes. Once the rental is being reported on a net-income basis, the owner typically files Form 1040-NR and any required state returns."
  - q: "What is the Section 871(d) election?"
    a: "It is an election that allows rental income to be treated as effectively connected income, so the owner is taxed on net income after deductions rather than under a gross withholding approach."
  - q: "Does the way the property is held matter?"
    a: "Yes. Direct ownership, ownership through a U.S. LLC, or ownership through a foreign entity can affect withholding, filing mechanics, future FIRPTA exposure, and estate tax planning."
---
...
{{< callout title="Where owners get stuck" tone="warning" >}}
Many foreign owners do not discover the Section 871(d) election issue until several years in, after gross withholding, missing ITIN steps, or inconsistent return filing has already created cleanup work.
{{< /callout >}}
