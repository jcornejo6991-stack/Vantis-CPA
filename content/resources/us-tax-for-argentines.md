---
title: "U.S. Tax for Argentines: U.S. LLCs, Expat Filing, and Cross-Border Planning"
description: "U.S. tax guide for Argentines and Americans in Argentina, including U.S. LLCs, inflation and valuation issues, foreign accounts, and U.S. real estate."
date: 2026-04-20
weight: 40
...
strategy_snapshot:
  ...
  bullets:
    - label: Searches usually start with
      text: "U.S. tax for Argentines, Argentine-owned U.S. LLC, American living in Argentina taxes, or U.S. real estate for Argentine investors."
    - label: Best consulting use
      text: "Review ownership, basis, and documentation before the move, the investment, or the U.S. filing date forces a rushed answer."
    - label: Biggest trap
      text: "Waiting until after the structure is in place to ask how the U.S. will view the entity, the accounts, or the sale proceeds."
faqs:
  - q: "Does Argentina have a U.S. income tax treaty?"
    a: "Argentina is not currently listed on the IRS U.S. income tax treaty A-to-Z page, so Argentina cases often rely more on structure, foreign tax credit coordination, and cash-movement planning than on treaty positions."
  - q: "Do Americans living in Argentina still file U.S. taxes?"
    a: "Yes. U.S. citizens and many green card holders generally continue filing Form 1040 each year while living in Argentina, and many also need FBAR or Form 8938 reporting for Argentine financial accounts."
  - q: "Can an Argentine resident own a U.S. LLC or U.S. property?"
    a: "Yes. The planning question is how the ownership should be structured, how the U.S. side will be reported, and how rental income, business profits, or sale proceeds will move back to Argentina."
---
...
The IRS maintains the official [U.S. income tax treaty list](https://www.irs.gov/businesses/international-businesses/united-states-income-tax-treaties-a-to-z), and Argentina is not currently listed there. That often means the planning leans more heavily on ownership, reporting, and foreign tax credit coordination than on treaty positions.
...
If you are an Argentine owner or investor entering the U.S., start with [Foreign Business and Investors](/services/international-tax/foreign-business-and-investors/).
{{< /callout >}}
