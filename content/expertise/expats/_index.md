...
sections:
  - title: "The U.S. Taxes You No Matter Where You Live"
    body: |
  ...
  - title: "Getting It Right Saves You Money"
    body: |
...
specializations:
  - label: "Expat Form 1040 with Foreign Income"
  - label: "Foreign Tax Credit (FTC) Optimization"
  - label: "Foreign Earned Income Exclusion (FEIE)"
  - label: "FBAR Filing (FinCEN 114)"
  - label: "FATCA Reporting (Form 8938)"
  - label: "Streamlined Filing Compliance (Offshore)"
  - label: "Foreign Pension & Trust Reporting"
  - label: "State Tax Domicile & Severance"
  - label: "Self-Employment Tax for Expats"
  - label: "Social Security Totalization Agreements"
---
